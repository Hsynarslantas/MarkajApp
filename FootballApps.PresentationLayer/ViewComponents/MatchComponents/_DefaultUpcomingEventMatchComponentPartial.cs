...
{
    public class _DefaultUpcomingEventMatchComponentPartial:ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _DefaultUpcomingEventMatchComponentPartial(IHttpClientFactory httpClientFactory)
        {
